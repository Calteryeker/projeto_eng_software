...
public class DespesaViewController {
  ...
  public static void criarCategoria(Usuario usuario) throws UsuarioNaoEncontradoException {
    System.out.println();
  ...
  public void execute(int value, Usuario usuario)
      throws DadosNaoPreenchidosException, CategoriaNulaException, DespesaNaoEncontradaException,
        ...
        if (opcaoMenuP == 1) {
          ...
          try {
            ...
            for (int indice = 0; indice < categoriaList.size(); indice++) {
              System.out.println("-" + (indice + 1) + " " + categoriaList.get(indice).getNome());
            }
            ...
            if (categoriaNomeDespesa > categoriaList.size() || categoriaNomeDespesa < 1) {
              ...
              if (nomeDespesa.isBlank()) {
                ...
                if (decisaoConfirmacao == 1) {
                  ...
                  controladorDespesa.criarDespesa(
                      nomeDespesa,
                      valorDespesa,
                      localDate,
                      usuario.getCategorias().get(categoriaNomeDespesa - 1));
                  ControladorDadosPersistentes.getInstance().atualizarUsuario(usuario);
                  System.out.println("Despesa Criada com Sucesso!!");
                  System.out.println("Despesas do Usuario: " + usuario.getLogin());
                  ControladorDespesa.getInstance(usuario.getRepositorioDespesa())
                      .vizualizarDespesas();
          ...
          if (numeroCategoriaSelecionada > categoriaList.size() || numeroCategoriaSelecionada < 1) {
            ...
            if (!despesasList.isEmpty()) {
              ...
              for (int indice = 0; indice < despesasList.size(); indice++) {
                System.out.println("-" + (indice + 1) + " " + despesasList.get(indice));
              }
              ...
              if (numeroDespesaSelecionada > despesasList.size() || numeroDespesaSelecionada < 1) {
                ...
                Despesa despesaSelecionada = despesasList.get(numeroDespesaSelecionada - 1);
                ...
                if (decisaoConfirmacao == 1) {
                  ...
                  ControladorDespesa.getInstance(usuario.getRepositorioDespesa())
                      .removerDespesa(despesasList.get(numeroDespesaSelecionada - 1).getOrdem());
                  ControladorDadosPersistentes.getInstance().atualizarUsuario(usuario);
            ...
            try {
              if (!despesasList.isEmpty()) {
                ...
                if (numeroDespesaSelecionada > despesasList.size()
                  ...
                  for (int indice = 0; indice < categoriaList.size(); indice++) {
                    System.out.println(
                        "-" + (indice + 1) + " " + categoriaList.get(indice).getNome());
                  }
                  int categoriaNomeDespesa = Integer.parseInt(sc.nextLine());
                  if (categoriaNomeDespesa > categoriaList.size() || categoriaNomeDespesa < 1) {
                    ...
                    if (nomeDespesa.isBlank()) {
                      ...
                      if (decisaoConfirmacao == 1) {
                        ...
                        ControladorDespesa controladorDespesa =
                            ControladorDespesa.getInstance(usuario.getRepositorioDespesa());
                        controladorDespesa.alterarDespesa(
                            nomeDespesa,
                            despesaSelecionada.getOrdem(),
                            valorDespesa,
                            localDate,
                            usuario.getCategorias().get(categoriaNomeDespesa - 1));
                        ControladorDadosPersistentes.getInstance().atualizarUsuario(usuario);
